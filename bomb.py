...
\033[1;32m[-] GITHUB    :\033[1;32m Sakibbhai1234
...
if 'SAMIR'==user and '143'==pas:
	...
	os.system('xdg-openhttps://www.facebook.com/profile.php?id=100001487304934')
else:
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH SAKIB-PRO ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://youtube.com/@Anonymous")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
\t\033[1;32m                 
\t\033[1;32m                
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥SAKIB-PRO🔥 "+w+tim)
